  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-white">
      <header className="flex h-12 items-center border-b border-[0.5px] border-zinc-200 bg-zinc-50 px-6">
        <h1 className="text-sm font-medium text-zinc-900">MinIO Setup Guide</h1>
        <span className="ml-3 rounded-full bg-white px-2 py-0.5 text-[10px] font-medium text-zinc-400 ring-1 ring-inset ring-zinc-200">
          Self-hosted S3
        </span>
      </header>
